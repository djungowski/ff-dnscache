...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\dnscache on
     Windows, /home/user/dev/dnscache on Linux) in a file named
     dnscache@dominik.jungowski and copy that file to
